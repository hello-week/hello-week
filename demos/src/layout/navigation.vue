<template>
    <nav class="nav">
        <ul class="menu">
            ...
            <li class="menu__item"><a href="https://github.com/maurovieirareis/hello-week" class="menu__link" target="_blank">View in GitHub</a></li>
        </ul>
        <toggle id="toogle-theme" name="toggle" :checked="false" @toggleSwith="toggleTheme" />
    </nav>
</template>
