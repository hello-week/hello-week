export declare type CallbackFunction = (...args: string[]) => void;
export declare type CalendarOptions = {
...
export declare type DaysHighlight = {
    days: string[] | [string, string];
    title?: string;
    color?: string;
    backgroundColor?: string;
};
export declare type IntervalRange = {
    begin: number;
    end: number;
};
